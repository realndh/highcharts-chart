...
PTCS.Dropdown = class extends PTCS.BehaviorValidate(PTCS.BehaviorTooltip(PTCS.BehaviorFocus(
    ...
    <ptcs-hbar id="select" part="select-box" stretch="" display-mode\$="[[displayMode]]">
      <ptcs-list-item part="list-item" disabled="[[disabled]]" disable-tooltip item-value="selected-item-value"
