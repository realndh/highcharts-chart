...
PTCS.Simpleradio = class extends PTCS.BehaviorValidate(PTCS.BehaviorTooltip(PTCS.BehaviorFocus(
    ...
    static get template() {
      ...
      </svg><ptcs-label part="label" max-width="[[labelMaxWidth]]" multi-line="" label="[[label]]"></ptcs-label></div>`;
    }
