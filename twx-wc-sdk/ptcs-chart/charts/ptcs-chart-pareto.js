...
PTCS.ChartPareto = class extends BehaviorChart(PTCS.BehaviorFocus(PTCS.BehaviorStyleable(PTCS.ThemableMixin(PolymerElement)))) {
    static get template() {
        return html`
        <style>
        :host {
        ...
        <ptcs-chart-layout id="chart-layout" style="height:100%" part="chart-layout"
            ...
            <ptcs-chart-coord slot="chart" part="chart"
                ...
                <ptcs-chart-core-pareto id="chart" slot="chart" part="core-chart" style="pointer-events: auto"
                    ...
                    exportparts="bar"></ptcs-chart-core-pareto>
            </ptcs-chart-coord>
    ...
    _isZoomable(noXZoom, noYZoom, xZoomRange, yZoomRange, xZoomInterval, yZoomInterval, xZoomSlider, yZoomSlider, xZoomDrag, yZoomDrag,
        ...
        return this._showZoomX(noXZoom, xZoomRange, xZoomInterval, xZoomSlider, xZoomDrag, xZoomSelect,
            ...
            this._showZoomY(noYZoom, yZoomRange, yZoomInterval, yZoomSlider, yZoomDrag, yZoomSelect, noXZoom, flipAxes, xZoomSlider, showZoomButtons);
    }
