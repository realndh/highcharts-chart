...
PTCS.ChartBar = class extends BehaviorChart(PTCS.BehaviorFocus(PTCS.BehaviorStyleable(PTCS.ThemableMixin(PolymerElement)))) {
    static get template() {
        return html`
        <style>
        :host {
        ...
        <ptcs-chart-layout id="chart-layout" style="height:100%" part="chart-layout"
            ...
            <ptcs-chart-coord slot="chart" part="chart"
                ...
                <ptcs-chart-core-bar slot="chart" id="chart"  part="core-chart" style="pointer-events: auto"
                    ...
                    exportparts="bar"></ptcs-chart-core-bar>
            </ptcs-chart-coord>
