...
PTCS.ChartSchedule = class extends BehaviorChart(PTCS.BehaviorFocus(PTCS.BehaviorStyleable(PTCS.ThemableMixin(PolymerElement)))) {
    static get template() {
        return html`
        <style>
        :host {
        ...
        return {
            ...
            */
            ...
            _isZoomable$tb: {
                ...
                computed: '_isZoomable(noXZoom, noYZoom, xZoomRange, yZoomRange, xZoomInterval, yZoomInterval, xZoomSlider, yZoomSlider, zoomDrag, zoomSelect, flipAxes, showZoomButtons)'
            },
    ...
    _isZoomable(noXZoom, noYZoom, xZoomRange, yZoomRange, xZoomInterval, yZoomInterval,
        xZoomSlider, yZoomSlider, zoomDrag, zoomSelect, flipAxes, showZoomButtons) {
        return this._showZoomX(noXZoom, xZoomRange, xZoomInterval, xZoomSlider, zoomDrag, zoomSelect, flipAxes, yZoomSlider, showZoomButtons) ||
            this._showZoomY(noYZoom, yZoomRange, yZoomInterval, yZoomSlider, zoomDrag, zoomSelect, flipAxes, xZoomSlider, showZoomButtons);
    }
    ...
    _showZoom(noZoom, zoomRange, zoomInterval, zoomSlider, zoomMouse, horzAxis, sliderAlt, showZoomButtons) {
        if (noZoom) {
            return false;
        }
        return zoomRange || zoomInterval || zoomSlider || zoomMouse || (horzAxis && sliderAlt || showZoomButtons);
    }

    _showZoomX(noXZoom, xZoomRange, xZoomInterval, xZoomSlider, zoomDrag, zoomSelect, flipAxes, yZoomSlider, showZoomButtons) {
        const zoomMouse = [zoomDrag, zoomSelect].find(item => item === 'x' || item === 'xy');
        return this._showZoom(noXZoom, xZoomRange, xZoomInterval, xZoomSlider, zoomMouse, flipAxes, yZoomSlider, showZoomButtons);
    }

    _showZoomY(noYZoom, yZoomRange, yZoomInterval, yZoomSlider, zoomDrag, zoomSelect, flipAxes, xZoomSlider, showZoomButtons) {
        const zoomMouse = [zoomDrag, zoomSelect].find(item => item === 'y' || item === 'xy');
        return this._showZoom(noYZoom, yZoomRange, yZoomInterval, yZoomSlider, zoomMouse, !flipAxes, xZoomSlider, showZoomButtons);
    }
