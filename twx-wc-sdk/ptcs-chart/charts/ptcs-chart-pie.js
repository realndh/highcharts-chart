...
PTCS.ChartPie = class extends BehaviorChart(PTCS.BehaviorFocus(PTCS.BehaviorStyleable(PTCS.ThemableMixin(PolymerElement)))) {
    static get template() {
        return html`
        <style>
        :host {
        ...
        <ptcs-chart-layout id="chart-layout" style="height:100%" part="chart-layout"
                           ...
                           legend-pos="[[legendPos]]" hide-legend="[[_hideLegend(hideLegend, _invalidData, _legend)]]"
            ...
            <ptcs-chart-core-pie id="chart" slot="chart" part="core-chart"
                ...
                on-chart-selection="_onSelectionChanged"></ptcs-chart-core-pie>
    ...
    _computeHideToolbar(_showSelectAll, showLegendButton) {
        return !_showSelectAll && !showLegendButton;
    }
    ...
    _hideLegend(hideLegend, invalidData, _legend) {
        return hideLegend || invalidData || !(_legend instanceof Array) || !(_legend.length > 0);
    }
