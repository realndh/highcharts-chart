...
PTCS.ChartWaterfall = class extends BehaviorChart(PTCS.BehaviorFocus(PTCS.BehaviorStyleable(PTCS.ThemableMixin(PolymerElement)))) {
    static get template() {
        return html`
        <style>
        :host {
        ...
        <ptcs-chart-layout id="chart-layout" style="height:100%" part="chart-layout"
            ...
            <ptcs-chart-coord slot="chart" part="chart"
                ...
                <ptcs-chart-core-waterfall id="chart" slot="chart" part="core-chart" style="pointer-events: auto"
                    ...
                    exportparts="bar"></ptcs-chart-core-waterfall>
            </ptcs-chart-coord>
    ...
    _isZoomable(noXZoom, noYZoom, xZoomRange, yZoomRange, xZoomInterval, yZoomInterval, xZoomSlider, yZoomSlider, xZoomDrag, yZoomDrag,
        ...
        return this._showZoomX(noXZoom, xZoomRange, xZoomInterval, xZoomSlider, xZoomDrag, xZoomSelect,
            noYZoom, flipAxes, yZoomSlider, showZoomButtons) ||
            this._showZoomY(noYZoom, yZoomRange, yZoomInterval, yZoomSlider, yZoomDrag, yZoomSelect,
                noXZoom, flipAxes, xZoomSlider, showZoomButtons);
    }
    ...
    _showZoom(noZoom, zoomRange, zoomInterval, zoomSlider, zoomDrag, zoomSelect, altZoom, showZoomButtons) {
        if (noZoom) {
            return altZoom;
        }
        return zoomRange || zoomInterval || zoomSlider || zoomDrag || zoomSelect || altZoom || showZoomButtons;
    }

    _showZoomX(noXZoom, xZoomRange, xZoomInterval, xZoomSlider, xZoomDrag, xZoomSelect, noYZoom, flipAxes, yZoomSlider, showZoomButtons) {
        return this._showZoom(noXZoom, xZoomRange, xZoomInterval, xZoomSlider, xZoomDrag, xZoomSelect, !noYZoom && !flipAxes && yZoomSlider,
            showZoomButtons);
    }

    _showZoomY(noYZoom, yZoomRange, yZoomInterval, yZoomSlider, yZoomDrag, yZoomSelect, noXZoom, flipAxes, xZoomSlider, showZoomButtons) {
