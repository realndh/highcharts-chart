...
PTCS.Axis = class extends PTCS.BehaviorFocus(PTCS.BehaviorStyleable(PTCS.ThemableMixin(PolymerElement))) {
    ...
    static get observers() {
        return [
            ...
            '_updateScale(_type, side, reverse, scaleMin, scaleMax, size, dualTicks, outerPadding, innerPadding, numberFormat, numberFormatSpecifier, dateFormatToken, tickFormat)',
    ...
    ready() {
        ...
        this.$.ticks.addEventListener('mousedown', ev => this._clickTick(ev));
