...
PTCS.ChartLayout = class extends PTCS.BehaviorStyleable(PTCS.ThemableMixin(PolymerElement)) {
    ...
    static get observers() {
        return [
            ...
            '_updateLayout(effTitlePos, effNotesPos, effLegendPos, sparkView, flipAxes, flipXAxis, flipYAxis, xAxis, yAxis, xAxis2, yAxis2, xZoom, yZoom, actionBar)'
        ];
    }
    ...
    __updateLayout() {
        ...
        const actionBar = this.sparkView ? null : this.actionBar;
        ...
        const _xZoom = this.xZoom && !this.sparkView;
        const _yZoom = this.yZoom && !this.sparkView;
