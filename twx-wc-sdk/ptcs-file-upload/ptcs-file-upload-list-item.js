                ...
                <div id="file-to-upload" part="file-to-upload">
                    <div class="file-info">
                        <svg part="file-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="24" fill="none" viewBox="0 0 20 24"
                            ...
                            <path fill="#6E717C" fill-rule="evenodd" d="M17 22.5H5A1.5 1.5 0 013.5 21V3A1.5 1.5 0 015 1.5h9v4A1.5 1.5 0 0015.5
                                7h3v14a1.5 1.5 0 01-1.5 1.5zM20 6l-5-6H5a3 3 0 00-3 3v18a3 3 0 003 3h12a3 3 0 003-3V6z" clip-rule="evenodd"/>
                            <g>
                                <rect width="17" height="8" y="12" fill="#6E717C" rx="1"/>
                    ...
                    <div class="file-actions">
                        ...
                        <ptcs-link id="file-replace" part="file-replace" label="Replace" tabindex\$="[[_delegatedFocus]]" disabled="[[disabled]]">
                        </ptcs-link>
