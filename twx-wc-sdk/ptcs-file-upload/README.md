...
| showRepositorySelector       | Boolean  | If TRUE, the component will include a repository selector. Default: False.     | No
| showRepositoryPath       | Boolean  | If TRUE, the component will include a repository path that the user can upload the file(s) to. Default: False.     | No
| fileUploadType       | String  | Sets the file upload control type (select/drag). If set to "Select file", the uploader is presented as a button that the user can click to open a file selection dialog box. If set to "drop zone", the file upload is presented as a drag-and-drop box where the user drags the files to upload, or alternatively the user can click anywhere in the box to browse for files. Default: drag.     | No
...
| title       | String  | Defines the label text for the component. If not set, the component does not have a title.     | No
| titleStyle       | String  | Sets the label text style for the component.     | No
| description       | String  | Defines the description text for the component. If not set, the component does not have a description.     | No
| descriptionStyle       | String  | Sets the description text style for the component.     | No
