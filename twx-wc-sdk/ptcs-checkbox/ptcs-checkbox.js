...
PTCS.Checkbox = class extends PTCS.BehaviorValidate(PTCS.BehaviorTooltip(PTCS.BehaviorFocus(
    ...
    <ptcs-label part="label" id="label" exportparts\$="[[_exportparts]]" label\$="[[label]]" hidden="[[!label]]"
