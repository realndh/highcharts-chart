...
PTCS.DynamicPanel = class extends PTCS.BehaviorTooltip(PTCS.BehaviorFocus(PTCS.BehaviorStyleable(PTCS.ThemableMixin(PolymerElement)))) {
    static get template() {
        return html`
        <style>
        :host {
    ...
    _resize(ev, x0, y0) {
        ...
        let posX, posY;
        ({posX, posY} = this.__getCoordinatesFromEvent(ev));
