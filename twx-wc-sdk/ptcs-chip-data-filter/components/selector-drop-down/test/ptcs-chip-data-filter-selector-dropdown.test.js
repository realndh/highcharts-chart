...
describe('<ptcs-chip-data-filter-selector-dropdown>-<text-case>', () => {
    ...
    it('does Apply button behave correctly', done => {
        PTCS.flush(() => {
...
describe('<ptcs-chip-data-filter-selector-dropdown>-<text-select-case>', () => {
    ...
    it('parses and passes selectOptions displaying dropdown control', done => {
    ...
    it('parses, passes selectOptions and applies default in dropdown', done => {
...
describe('<ptcs-chip-data-filter-selector-dropdown>-<number-case>', () => {
    ...
    it('is saving handled properly & query generated correctly, single value', done => {
        PTCS.flush(() => {
            // unhappy path
            let valToBeInserted = '';
...
describe('<ptcs-chip-data-filter-selector-dropdown>-nothingSelectedYet', () => {
    ...
    it('are text field & apply button disabled after entering data', done => {
        selector.customBaseTypesMapping = {default: 'string', infotable: 'unsupported', integer: 'number'};
        selector.data = data;
