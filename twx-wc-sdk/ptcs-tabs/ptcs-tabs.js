...
PTCS.Tabs = class extends PTCS.BehaviorStyleable(TabsElement) {
    ...
    static get template() {
        ...
        template = html`
      ${stemplate}
      <ptcs-dropdown id="tabslist" part="tabs-list" display-mode="small" icon="cds:icon_more_horizontal_mini" tabindex="0"
      exportparts="select-box : tabs-list-select-box, icon : tabs-list-icon"
      items="[[_offScreenItems]]" disabled="[[disabled]]" state-selector="[[_itemStateSelector]]" selector="name" value-selector="value"
