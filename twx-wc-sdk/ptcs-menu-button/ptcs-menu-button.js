...
variant="[[menuColor]]" menu-max-width="[[_computeWidth(menuMaxWidth)]]" menu-min-width="[[_computeWidth(menuMinWidth)]]"
...
PTCS.MenuButton = class extends PTCS.BehaviorTooltip(PTCS.BehaviorFocus(PTCS.BehaviorStyleable(PTCS.ThemableMixin(PolymerElement)))) {
    static get template() {
        return html`
            <style>
             :host {
            ...
            <ptcs-button id="button" disabled="[[disabled]]" part="button" tabindex\$="[[_delegatedFocus]]" selected\$="[[_selected]]"
                variant="[[buttonVariant]]" icon="[[icon]]" label="[[label]]"
                disable-tooltip="[[disableTooltip]]" tooltip="[[tooltip]]" tooltip-icon="[[tooltipIcon]]"
                content-align="[[contentAlign]]" icon-placement="[[iconPlacement]]" button-max-width="[[buttonMaxWidth]]">
            </ptcs-button>
        `;
    }
