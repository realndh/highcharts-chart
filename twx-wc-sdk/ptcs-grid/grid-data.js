...
export class DataManager {
    ...
    // Insert data item
    // TODO: How to insert an item in a tree model?
    ...
    */
    ...
    insertTreeItem(item, baseIndex, where, validation) {
        ...
        if (where === 'child') {
            ...
            if (this._mapSubItems.get(this._items[baseIndex]) || this._subItemsState(this._items[baseIndex], baseIndex) !== undefined) {
