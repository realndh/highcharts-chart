...
// A virtual scroller
PTCS.VScroller2 = class extends PTCS.BehaviorFocus(PolymerElement) {
    static get is() {
    ...
    _resizeItemEv() {
        ...
        if (resized) {
            requestAnimationFrame(() => {
                if (this.viewportHeight - this._aboveH > this._itemsH && (this._startIx > 0 || this._endIx < this._numItems)) {
    ...
    _keyDown(ev, keepTrackOfFocusOnly = false) {
        ...
        if (this.disabled || (!PTCS.hasFocus(this) && !keepTrackOfFocusOnly)) {
            return;
        }
