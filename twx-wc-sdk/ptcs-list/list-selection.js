...
export class ListSelection {
    ...
    */
    ...
    _selectedItemsChanged(_selectedItems) {
        ...
        if (this._multiSelect) {
            ...
            if (_selectedItems) {
                this._items.forEach((item, index) => {
                    ...
                    const found = _selectedItems.find(e => v === this._valueOf(e));
        ...
        } else if (_selectedItems && _selectedItems.length > 0) {
            // Single selection mode. Only use selectedItems[0]
            const v = this._valueOf(this._selectedItems[0]);
            const selected = this._items.findIndex(item => this._valueOf(item) === v);
            this._selected = selected;
